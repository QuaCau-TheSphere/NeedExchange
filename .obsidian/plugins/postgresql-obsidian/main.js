...
var SettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("PostgreSQL connection URL").setDesc("This connection URL will be used to send your data.").addText((text) => text.setPlaceholder("").setValue(this.plugin.settings.connectionUrl).onChange((url) => __async(this, null, function* () {
...
var PostgreSQLPlugin = class extends import_obsidian2.Plugin {
    ...
    return __async(this, null, function* () {
      ...
      this.addCommand({
        ...
        callback: () => __async(this, null, function* () {
          ...
          const db = yield this.getDatabaseClient();
          ...
          try {
            yield db.query(`INSERT INTO obsidian.file (path, dataview_data)
            ...
            new import_obsidian2.Notice("PostgreSQL error: " + err.message);
            throw err;
          }
          new import_obsidian2.Notice("Inserted page");
        })
      });
    });
  }
  getDatabaseClient() {
    return __async(this, null, function* () {
      if (!this.settings.connectionUrl) {
        new import_obsidian2.Notice("PostgreSQL: there is no connection string defined");
      ...
      try {
        ...
        new import_obsidian2.Notice("Connected to PostgreSQL");
      } catch (err) {
        new import_obsidian2.Notice("PostgreSQL connection error: " + err.message);
        throw err;
      }
      this.db = client;
      yield this.db.query(`CREATE SCHEMA IF NOT EXISTS obsidian;
  ...
  onunload() {
    return __async(this, null, function* () {
      var _a;
      yield (_a = this.db) == null ? void 0 : _a.end();
    });
  }
  loadSettings() {
    return __async(this, null, function* () {
